...
class MasterDatabasePasswordsDaoTest {
    ...
    fun insertAndGetAllPasswords_shouldReturnCorrectPasswords() = runTest {
        ...
        assertThat(allPasswords).containsExactly(password2.copy(id = 2), password1.copy(id = 1))
            .inOrder()
    ...
    fun insertAndGetPasswordById_shouldReturnCorrectPassword() = runTest {
        ...
        val originalPassword = PasswordEntity(
            domain = "domain.com",
            username = "user",
            password = "pass",
            notes = "some notes"
        ...
        val insertedId =
            passwordsDao.insertPassword(originalPassword) // Insert and get the generated ID
    ...
    fun insertAndGetPasswordByUsernameAndDomain_shouldReturnCorrectPassword() = runTest {
        ...
        val passwordToFind = PasswordEntity(
            domain = targetDomain,
            username = targetUsername,
            password = "pwd",
            notes = "find me"
        )
        val otherPassword = PasswordEntity(
            domain = "other.net",
            username = "other",
            password = "xyz",
            notes = "not me"
        ...
        val retrievedPassword =
            passwordsDao.getPasswordByUsernameAndDomain(targetUsername, targetDomain)
    ...
    fun deletePasswordById_shouldDeleteCorrectly() = runTest {
        ...
        val passwordToDelete = PasswordEntity(
            domain = "delete.me",
            username = "trash",
            password = "123",
            notes = "delete this"
