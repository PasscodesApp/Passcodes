package com.jeeldobariya.passcodes.presentation.main_screen
...
@Composable
private fun ClassicalMainScreenContent(navigateTo: (Route) -> Unit) {
    Scaffold { padding ->
        Column(
            modifier = Modifier
                .fillMaxSize()
...
@Preview
@Composable
private fun ClassicalMainScreenPreview() {
    PasscodesTheme {
        ClassicalMainScreenContent(navigateTo = { })
    }
}
